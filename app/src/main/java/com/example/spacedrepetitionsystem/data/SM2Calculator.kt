...
object SM2Calculator {
     ...
     *        5: Hoàn hảo (Perfect)
     *        4: Nhớ nhưng cần suy nghĩ (Correct after hesitation)
     *        3: Nhớ nhưng rất khó khăn (Correct with serious difficulty)
     *        2: Sai nhưng nhận ra đáp án (Incorrect, easy to recall)
     *        1: Quên hoàn toàn (Incorrect, remembered after seeing)
     *        0: Không biết gì (Blackout)
